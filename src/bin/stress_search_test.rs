...
fn main() {
    ...
    board2.set_from_fen("r1bqkbnr/ppp1pppp/2n5/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 0 4").unwrap();
    ...
    board3.set_from_fen("r2q1rk1/ppp2ppp/2nP1n2/2b1p3/2B1P3/3P1N2/PPP2PPP/RNBQR1K1 w - - 0 8").unwrap();
    ...
    board4.set_from_fen("8/5pk1/3p1p1p/4P3/8/4K3/8/8 w - - 0 1").unwrap();
